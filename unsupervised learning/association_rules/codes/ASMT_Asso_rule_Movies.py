...
movies_df = pd.read_csv(r"E:\360digitMG\ASsignments\9.Association rules\my_movies.csv")
movies_df1 = movies_df.iloc[:,5:]

frequent_itemsets = apriori(movies_df1, min_support = 0.0075, max_len = 4, use_colnames = True)
...
''' "Sixth sense", "Gladiator" & "Patriot" are the highest watching movies
For 2 item list - person who watch "LOTR1" will consecutively watch "LOTR2" on the basis of lift ratio and support
                 person who watch "Harry Potter1" will consecutively watch "Harry Potter2" on the basis of lift ratio and support
For 3 item list - person who like "Gladiator" and "Sixth Sense" rarely be like "Green Mile"
                  
For 4 item list - person who wacth 3 movies will definitly be like "GreenMile" as a 4th one'''
