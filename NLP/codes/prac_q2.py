### NLP Assignment ####
## Text summarization of dataset 'NLP_TM.txt'##
...
with open(r"E:\360digitMG\ASsignments\NLP\NLP-TM.txt" , encoding="utf8") as file:
    TM = file.read()
TM

len(sent_tokenize(TM))

summarize(TM)

summarize(TM, num_sentences=1)
