...
sentence.split().index('TextMining') # Split the sentences into words (removing Spaces) and present the position
...
sentence3 = word_tokenize("Natural Luanguage Processin deals with the art of extracting insightes from Natural Languaes")
print(sentence3)
